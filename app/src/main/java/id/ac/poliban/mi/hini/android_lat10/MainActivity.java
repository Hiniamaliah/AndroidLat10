package id.ac.poliban.mi.hini.android_lat10;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPhone.setOnClickListener(view -> {
            Uri uri = Uri.parse("tel: 081346589012");
        ...
        btEmail.setOnClickListener(view -> {
            Uri uri = Uri.parse("mailto: Hiniamaliah.1029@gmail.com.");
            Intent intent = new Intent();
            intent.setAction(Intent.ACTION_VIEW);
            intent.setData(uri);
            startActivity(intent);
        ...
        btWebsite.setOnClickListener(view -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Hiniamaliah") )));
